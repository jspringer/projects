...
[Library Catalog](https://github.com/jspringer/django-library-catalog) (Django, Open Library, PostgreSQL) - [Demo](http://jsnspr-django-library.herokuapp.com/) (l: ``admin`` (superuser) or ``test`` (basic user), p: ``Qaz2Wsx#Edc``)
